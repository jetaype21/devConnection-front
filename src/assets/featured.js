export const featureds = [
  ...
  {
    tool_name: "inteligencia artificial",
    tool_description:
  ...
  {
    tool_name: "biblioteca de imágenes",
    tool_description:
